...
import { getProducts, getSettings, saveQuote, checkJobIdUnique, saveSettings, getCustomers, getSupabase, getCurrentUserProfile, uploadFileToStorage } from './db.js?v=87';
import { formatCurrency, showToast, fileToBase64, generateJobIdSuggestion, compressImage, parseCombinedAddress } from './utils.js?v=87';
import { navigateToView, viewQuoteDetails, getPreviousViewId } from './app.js?v=87';
import { renderQuoteDetails } from './quotes-list.js?v=87';
import { openCustomerModalInline } from './customers.js?v=87';
