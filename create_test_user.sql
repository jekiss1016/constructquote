...
BEGIN
  ...
  IF v_user_id IS NULL THEN
    ...
    RAISE NOTICE 'Inserted new user % with instance_id and email_confirmed_at', v_email;
  ELSE
    -- Update existing user attributes required by GoTrue (confirmed_at is a generated column)
    UPDATE auth.users
